...
- Page selectors are zero-indexed, so `page=0` yields the first chunk and `page=1` advances to the second (`test_fetch_or_populate_persists_pages_and_enforces_ttl`).
